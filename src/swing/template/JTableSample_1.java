...
public class JTableSample_1 implements ActionListener{
	...
	// 속지를 그리는데 사용됨 - 이 속지에 처리버튼과 종료버튼을 추가해보자.
	...
	@Override
	public void actionPerformed(ActionEvent e) { // 자바에서 대신 주입해준다. ActionEvent 그래서 null이 아니다.
