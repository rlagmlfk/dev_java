...
public class Ex14_10_1 {
	...
	public static void main(String[] args) {
		...
		// maxBy()반환 타입이 Optional<Student>라서 위와 같은 결과
		// Student로 반환결과 얻으려면 collectiongAndThen()과 Optional::get 함께 사용
		...
		System.out.printf("%n4. 다중분할(성별 불합격자, 150점 이하)%n");
		
		// 성적이 150점 아래인 학생들 불합격 처리
		// 불합격자를 성별로 분류하여 얻어내려면?
		// partitioningBy()를 한 번 더 사용해서 이중분할
