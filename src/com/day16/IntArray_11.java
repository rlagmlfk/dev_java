...
public class IntArray_11 {
	...
	// 아래 메소드가 호출되어야 deptnos 1차배열의 초기화가 된다.
	public void initArray() {
		deptnos[0] = 10; // deptnos[0]=10
		deptnos[1] = 20; // deptnos[0]=20
		deptnos[2] = 30; // deptnos[0]=30
	} // end of initArray
	// length: 배열의 원소의 갯수를 카운트해줌
	...
	public static void main(String[] args) {
		// 배열을 초기화하는 initArray호출 또 초기화된 배열을 출력하는 arrayPrint호출
		// 모두 생성자에서 처리되었다.-> 생성자 호출이 필요
		new IntArray_11();
	} // end of main
